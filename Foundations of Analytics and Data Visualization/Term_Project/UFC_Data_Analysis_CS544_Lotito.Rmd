...
Now that we know the average age of fighters in the UFC being ~29.5, I wanted to dive deeper into these age groups to see out of the population what is the ages of fighters that are fighting for a title. To do this, I filtered the data on title_bout == True and pulled in both the ages of the blue fighters and red fighters. Below is the the results. The average is slightly lower at ~29.25, but a negligible difference. This histogram also tells us that as the fighters gain more experience in the sport they are more likely to be in a title bout, but even with it tappering off at ~33 years old there is again another spike around 35 years old inferring to us that there is more older fighters that hold a title and are holding it longer or fighters are given a chance to fighter for a title as they get more established in their career before they retire.
