...
first_and_last_version1 <- scores_matrix[c(1,2), c(1, ncol(scores_matrix))]
...
first_and_last_version2 <- named_matrix[c(1,2), c(1,ncol(named_matrix))]
first_and_last_version2

mat_1 <- x[ , ncol(x), drop = FALSE]

mat_2 <- x[ , 1, drop = FALSE]
